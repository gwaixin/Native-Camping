...
Negotiator._makeOffer = function(connection) {
  ...
  pc.createOffer(function(offer) {
    ...
    // }
		...
		// check if bit rates, audio and video exist
		if (
			typeof connect.setSDPBitRates !== 'undefined' &&
			typeof constant.videoBitRate !== 'undefined' &&
			typeof constant.audioBitRate !== 'undefined'
		) {
			offer.sdp = connect.setSDPBitRates(offer.sdp, constant.videoBitRate, constant.audioBitRate);
		}
  ...
  pc.createAnswer(function(answer) {
    ...
    // }
		...
		if (
			...
			answer.sdp = connect.setSDPBitRates(answer.sdp, constant.videoBitRate, constant.audioBitRate);
		}
...
var defaultConfig = {'iceServers': [
	...
	{url: "stun:stun.sipgate.net", urls: "stun:stun.sipgate.net"},
	{url: "stun:217.10.68.152", urls: "stun:217.10.68.152"},
	...
	{url: "turn:153.120.105.84:3478?transport=tcp", urls: "turn:153.120.105.84:3478?transport=tcp", username: "nativecamp_user", credential: "4Jq3NHHdfTJsxGGA"},
	{url: "turn:153.120.105.84:3478?transport=udp", urls: "turn:153.120.105.84:3478?transport=udp", username: "nativecamp_user", credential: "4Jq3NHHdfTJsxGGA"}
]};
var dataCount = 1;
